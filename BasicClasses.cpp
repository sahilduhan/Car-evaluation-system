...
public:
	...
	void setHistory() 	// for taking input of data members
	{
		...
		cin >> yrsOld;
		if (yrsOld > 15 || yrsOld < 0){
			while (yrsOld > 15 || yrsOld < 0){
...
public:
	...
	void setPaint()       // for taking input of data members
	{
		...
		cin >> paintThickness;
		if (paintThickness < 0.0 || paintThickness>200.0){
			while (paintThickness < 0.0 || paintThickness>200.0){
				cout << "\t\t\t\t\t  Please enter paint thickness between 0 and 200\n";
				cin >> paintThickness;
			}
		}
...
public:
	...
	void setAlignment() 	// for taking input of data members
	{
		...
		cin >> thrustAngle;
		if (thrustAngle > 5.0){
			while (thrustAngle > 5.0){
				cout << "\t\t\t\t\t Please enter an angle less than 5 degrees\n";
				cin >> thrustAngle;
			}
		}
		calculateWARating();
